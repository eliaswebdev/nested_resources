class ModelsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @model.save
        format.html { redirect_to make_models_url(@make), notice: 'Model was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @model.update(model_params)
        format.html { redirect_to make_models_url(@make), notice: 'Model was successfully updated.' }
  ...
  def destroy
    @model.destroy
    respond_to do |format|
      format.html { redirect_to make_models_url(@make), notice: 'Model was successfully destroyed.' }
